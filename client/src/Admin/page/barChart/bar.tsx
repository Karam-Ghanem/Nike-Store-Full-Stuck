...
const Bar = ({ isDashbord = false, products = [] }: Props) => {
  const theme = useTheme();
  const data = products.length > 0
    ? products.map((product) => ({ product: product.name, quantity: product.quantity }))
    : [{ product: "No data", quantity: 0 }];
